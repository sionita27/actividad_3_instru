...
\emph{toda} la capa nueva vive en un único módulo \codein{diagnostics} y el
resto de módulos heredados se han tocado lo justo (sólo un \emph{getter}
adicional en \codein{elevator} para forzar el estado \textsf{ALARM});
\emph{(C4)}\ la presentación sigue el formato pedido (Carlito $\equiv$
...
real manteniendo la misma API de \codein{diagnostics}; añadir un
