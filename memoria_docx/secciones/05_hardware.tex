...
\texttt{diagram.json} y se reproduce en la figura~\ref{fig:wokwi}.
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.27\textwidth} p{0.38\textwidth} p{0.27\textwidth}}
    ...
    LCD 20×4      & HMI por I\textsuperscript{2}C (0x27).          & 21 (SDA), 22 (SCL) \\
...
es 0–800 mA con umbral de sobreconsumo en
500 mA.
...
control parten apagados y el receptor IR queda en \texttt{HIGH}, compatible
