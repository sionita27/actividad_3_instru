...
convivencia en el mismo \texttt{loop()}: cuando el clasificador confirma una
caja \emph{alta}, su altura se mapea a una planta del ascensor y se invoca
\texttt{elevator\_request()} automáticamente, de modo que la caja desviada al
...
el reparto de evaluación (el Criterio~2, que vale el 40 \%, premia
...
---\texttt{diagnostics}--- que se interpone entre los sensores y el lazo de
